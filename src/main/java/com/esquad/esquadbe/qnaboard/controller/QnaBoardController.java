...
public class QnaBoardController {
    ...
    @PutMapping("/{id}")
    public QnaBoardResponseDTO updateQuestion(@PathVariable Long id, @RequestBody QnaRequestDTO updateForm, Principal principal) {
        return questionService.updateQuestion(id, updateForm, principal);
    }
